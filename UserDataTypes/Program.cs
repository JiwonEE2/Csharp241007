    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            - 단, 기본 자료형과 같이 값형식을 구현하기 위해 string 클래스에 처리를 값형식처럼 동작하도록 구현
            ...
            */
            ...
            Console.WriteLine("Academy를 test로 변경 : {0}", str5.Replace("Academy", "test"));  // false
